...
DEFAULT_HF_REPO_ID = "tranqui247/adsus"
DEFAULT_HF_FILENAME = "YOLO26_EffNetV2S_512_40H1_nbl.pt"
...
_model = None
_current_repo_id = DEFAULT_HF_REPO_ID
_current_filename = DEFAULT_HF_FILENAME
...
async def detect(
    ...
    selected_repo_id = repo_id or DEFAULT_HF_REPO_ID
    selected_filename = filename or DEFAULT_HF_FILENAME
    if _model is None or _current_repo_id != selected_repo_id or _current_filename != selected_filename:
        load_ai_model(selected_repo_id, selected_filename)
