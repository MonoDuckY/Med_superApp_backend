...
public class SmsGatewayController {
 ...
 @PostMapping("/devices/register") public ResponseEntity<ApiResponse<Void>> register(@RequestHeader("X-Gateway-Registration-Key") String key,@Valid @RequestBody GatewayDeviceRegistrationRequest request){service.register(key,request);return ResponseEntity.ok(ApiResponse.success("Gateway registered.",null));}
