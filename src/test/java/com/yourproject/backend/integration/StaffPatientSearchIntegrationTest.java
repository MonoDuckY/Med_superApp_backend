...
class StaffPatientSearchIntegrationTest extends MongoIntegrationTestBase {
    ...
    void staffSearchesActivePatientsByClosestName() throws Exception {
        ...
        String token = loginAccessToken("0944444444", "StaffPassword1!", "STAFF");
    ...
    void nonStaffCannotSearchPatients() throws Exception {
        ...
        String token = loginAccessToken("0944444444", "AdminPassword1!", "ADMIN");
    ...
    private String loginAccessToken(String phoneNumber, String password, String role) throws Exception {
